...
public class Class12ChapterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_class12_chapter );


        RootRef= FirebaseDatabase.getInstance ().getReference ();


        im1 = findViewById ( R.id. kar1p);
        im2 = findViewById ( R.id.kar2p );
        im3 = findViewById ( R.id. kar3p);
        im4 = findViewById ( R.id.kar4p );
        im5 = findViewById ( R.id.kar5p );
        im6 = findViewById ( R.id.kar6p );
        im7 = findViewById ( R.id. kar7p);
        im8 = findViewById ( R.id. kar8p);
        im9 = findViewById ( R.id.kar9p );
        im10 = findViewById ( R.id. kar10p);
        im11 = findViewById ( R.id.kar11p );
        im12 = findViewById ( R.id.kar12p );
        im13 = findViewById ( R.id.kar13p );
        im14 = findViewById ( R.id. kar14p);
        im15 = findViewById ( R.id. kar15p);
        im16 = findViewById ( R.id.kar16p );
        im17 = findViewById ( R.id. kar17p);
        im18 = findViewById ( R.id.kar18p );
        im19 = findViewById ( R.id.kar19p );
        im20 = findViewById ( R.id.kar20p );
        im21 = findViewById ( R.id. kar21p);
        im22 = findViewById ( R.id.kar22p );
        im23 = findViewById ( R.id.kar23p );
        im24 = findViewById ( R.id.kar24p );
        im25 = findViewById ( R.id. kar25p);



        progressDialog = new ProgressDialog ( Class12ChapterActivity.this);
        ...
        im1.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent ( Class12ChapterActivity.this,pdfviewerActivity.class );
    ...
    private void RetriveYouserInfo() {
        ...
        progressDialog.show ();
        RootRef.child ( "Class12" ).child ( "Study" )
                .addValueEventListener ( new ValueEventListener () {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        ...
                        Toast.makeText ( Class12ChapterActivity.this, "Error.", Toast.LENGTH_SHORT ).show ();
                        progressDialog.dismiss ();
                    }
                } );
    }
